...
### 優先度：高
- [x] 職人向けマニュアル `docs/manual/for-worker.md` を Notion ベースの実画像構成へ更新済み
  - **ケース0**：はじめて、友だち追加で始める場合
  - **ケース1**：友だち追加が終わっている人の場合
  - **メイン メニュー**：工事履歴 / 操作動画 / 工事情報フォーム / 写真選択 / 報告書リスト / あずさアドバイス
  - **サブ メニュー**：工事情報編集 / AIコメント / 写真追加 / サイン / 地図 / 作り直す / 削除
  - レイアウトは `docs/.vitepress/theme/custom.css` に追加したスマホ枠・比較レイアウト・4枚構成スタイルを利用
...
| ファイル名 | 撮影内容 |
|-----------|---------|
| `worker_case0_home.jpg` | 職人：ケース0 ホーム画面 |
| `worker_case0_add_friend.jpg` | 職人：ケース0 友だち追加画面 |
| `worker_case0_qr_scan.jpg` | 職人：ケース0 友だち追加QR読み取り |
| `worker_case0_first_message.jpg` | 職人：ケース0 初回メッセージ画面 |
| `worker_case0_register_button.jpg` | 職人：ケース0 登録するボタン表示 |
| `worker_case0_permission.jpg` | 職人：ケース0 許可画面 |
| `worker_case0_name_required.jpg` | 職人：ケース0 ユーザー登録フォーム |
| `worker_case0_keyboard.jpg` | 職人：ケース0 入力中画面 |
| `worker_case0_pending.jpg` | 職人：ケース0 登録申請中メッセージ |
| `worker_case0_info_form.jpg` | 職人：ケース0 工事情報フォーム |
| `worker_case0_notice.jpg` | 職人：ケース0 登録完了通知 |
| `worker_case0_notice_chat.jpg` | 職人：ケース0 登録完了後のチャット |
| `worker_case1_poster.png` | 職人：ケース1 QRポスター |
| `worker_case1_entry.png` | 職人：ケース1 登録済みメイン画面 |
| `worker_main_menu_overview.png` | 職人：メイン メニュー全体 |
| `worker_operation_video.png` | 職人：操作動画 |
| `worker_form_01.jpg` | 職人：工事情報フォーム 1枚目 |
| `worker_form_02.jpg` | 職人：工事情報フォーム 2枚目 |
| `worker_photo_select.jpg` | 職人：写真選択 1枚目 |
| `worker_photo_select_02.jpg` | 職人：写真選択 2枚目 |
| `worker_photo_select_03.jpg` | 職人：写真選択 3枚目 |
| `worker_photo_select_04.jpg` | 職人：写真選択 4枚目 |
| `worker_report_list.jpg` | 職人：報告書リスト 1枚目 |
| `worker_report_list_02.jpg` | 職人：報告書リスト 2枚目 |
| `worker_azusa_advice.jpg` | 職人：あずさアドバイス |
...
### 2026-04-19
- `docs/manual/for-worker.md` を Notion の `実践 Andoroid 画面1/2/3` と `指示内容（ケース0/ケース1）` に合わせて全面更新
- ケース0/ケース1、メイン メニュー、サブ メニューを実画像ベースで再構成
- `docs/.vitepress/theme/custom.css` にスマホ画像枠、比較レイアウト、4枚構成レイアウトを追加
- `docs/public/manual/worker_*` 一式を追加し、職人さん向け画像資産を整理
